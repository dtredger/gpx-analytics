...
class SailingSession():
    default_params = {
        # "wind_dir":              ,
        "stopped_threshold_ms":  3.5,
        "moving_threshold_ms":   4.5,
        "window_size":           5,
        "kts_speed_cap":         40,
        "timezone":              "US/Pacific"
    }
    ...
    def set_stats(self):
        ...
        with np.errstate(invalid="ignore"):
            ...
            stats["starboard_transition_success_percent"] = np.float64(100)*len(self.transitions_starboard)/(len(self.starboard_crashes)+len(self.transitions_starboard))
